                ...
                <div className="container mx-auto max-w-4xl">
                    <div className="bg-gradient-to-br from-cyan-500/20 to-blue-500/20 border border-cyan-500/30 rounded-xl p-12 text-center">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <Link to="/contact" className="bg-gradient-to-r from-purple-600 to-cyan-500 hover:from-purple-700 hover:to-cyan-600 px-6 py-3 rounded-lg font-semibold transition-all shadow-lg">
                                Contact Support
                            </Link>
