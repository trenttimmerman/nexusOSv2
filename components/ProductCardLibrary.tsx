...
export const ProductCardClassic: React.FC<ProductCardProps> = ({ product, onAddToCart, onNavigate }) => (
  <div className="group">
    <div 
...
export const ProductCardIndustrial: React.FC<ProductCardProps> = ({ product, onAddToCart, onNavigate }) => (
...
export const ProductCardFocus: React.FC<ProductCardProps> = ({ product, onAddToCart, onNavigate }) => (
  <div 
...
export const ProductCardHype: React.FC<ProductCardProps> = ({ product, onAddToCart, onNavigate }) => (
  <div className="group relative">
    ...
    <div 
      className="aspect-[4/5] bg-neutral-100 border-2 border-black rounded-xl overflow-hidden mb-3 relative shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] group-hover:translate-x-1 group-hover:translate-y-1 group-hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] transition-all cursor-pointer"
      onClick={onNavigate}
    >
...
export const ProductCardMagazine: React.FC<ProductCardProps> = ({ product, onAddToCart, onNavigate }) => (
...
export const ProductCardGlass: React.FC<ProductCardProps> = ({ product, onAddToCart, onNavigate }) => (
  <div 
