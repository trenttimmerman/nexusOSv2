...
const Header28: React.FC = () => {
    ...
    return (
        <header className="sticky top-0 z-50 h-24 bg-gray-900 text-white">
            <canvas ref={canvasRef} className="absolute inset-0 w-full h-full" />
             <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full">
                <div className="flex justify-between items-center h-full">
                    <a href="#" className="text-2xl font-bold tracking-widest">CONSTELLATION</a>
                    <nav className="hidden md:flex items-center space-x-8 text-sm font-semibold">
                        <a href="#" className="hover:opacity-80">Explore</a>
                        <a href="#" className="hover:opacity-80">Discover</a>
                        <a href="#" className="hover:opacity-80">Connect</a>
                    </nav>
                </div>
            </div>
        </header>
